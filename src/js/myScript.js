...
$('div.modal-content').find('form').submit(function (event){
...
let srok_tip = 0;
let price_tip = 0;    
let srok_adaptivnost = 0;
let price_adaptivnost = 0;
let srok_design = 0;
let price_design = 0;
...
//}
    ...
    console.log(srok_tip);
    console.log(price_tip);
...
if (opt == "Для телефонов и планшетов"){
    srok_adaptivnost = 4;
    price_adaptivnost = 3000;
}
...
if (opt == "И для мобильных и для ПК"){
    srok_adaptivnost = 6;
    price_adaptivnost = 5000;
}

if (opt == "Другое2"){
    srok_adaptivnost = "Несколько рублей + ";
    price_adaptivnost = "Несколько рублей + ";
}

let sroki;
let price;

if(opt == "Выберите пункт..." || opt == 0 || opt == "Другое" || opt == "Другое2"){
        sroki = "0 дней";
        price = "0 рублей";
    }
    else{
        let day = " дней";
        sroki = srok_tip + srok_adaptivnost + " дней";
        price = price_tip + price_adaptivnost + " рублей";
    }

console.log(sroki);
console.log(price);
console.log(srok_tip);
console.log(srok_design);
console.log(srok_adaptivnost);
...
//document.getElementById('tip1').options[0].text = "Txt";
//document.getElementById('tip2').options[0].text = "Txt";
//document.getElementById('tip3').options[0].text = "Txt";
    
$('div.modal-body').find('form').submit(function(event){
    event.preventDefault();
    ...
    $('div.contact').find('form').submit(function(event){
    event.preventDefault();
